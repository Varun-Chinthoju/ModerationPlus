...
app.post('/api/timeout', async (req, res) => {
    ...
    try {
        ...
        (0, stats_1.recordAction)(auth.guildId, {
            timestamp: new Date().toISOString(),
            targetUser: userTag,
        ...
        if (interaction.isChatInputCommand()) {
            ...
            if (commandName === 'setup') {
                ...
                if (guildId && rulesChannel && logChannel) {
                    (0, config_1.saveConfig)({ guildId, rulesChannelId: rulesChannel.id, modLogsChannelId: logChannel.id, auditInterval: 100, defaultTimeout: 10 });
